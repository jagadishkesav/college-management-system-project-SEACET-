...
public class semester5 extends AppCompatActivity {
    ...
    private void uploadFile(Uri data) {
        ...
        progressDialog.show();
        StorageReference sRef = mStorageReference.child("CSE/semester5" + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(semester5.this, "File succesfully uploaded......", Toast.LENGTH_SHORT).show();
    ...
    public void btn_action(View view) {
        startActivity(new Intent(getApplicationContext(),ViewSem5Pdf.class));
    }
}
