...
public class ECE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(ECE.this, android.R.layout.simple_list_item_1, SPINNERVALUES);
        ...
        GOTO.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(SpinnerValue){
                    ...
                    case "semester1":
                        intent = new Intent(ECE.this, ece_sem1.class);
                        startActivity(intent);
                        break;

                    case "semester2":
                        intent = new Intent(ECE.this, ece_sem2.class);
                        startActivity(intent);
                        break;
                    case "semester3":
                        intent = new Intent(ECE.this, ece_sem3.class);
                        startActivity(intent);
                        break;

                    case "semester4":
                        intent = new Intent(ECE.this, ece_sem4.class);
                        startActivity(intent);
                        break;
                    case "semester5":
                        intent = new Intent(ECE.this, ece_sem5.class);
                        startActivity(intent);
                        break;

                    case "semester6":
                        intent = new Intent(ECE.this, ece_sem6.class);
                        startActivity(intent);
                        break;
                    case "semester7":
                        intent = new Intent(ECE.this, ece_sem7.class);
                        startActivity(intent);
                        break;

                    case "semester8":
                        intent = new Intent(ECE.this, ece_sem8.class);
                        startActivity(intent);
                        break;
