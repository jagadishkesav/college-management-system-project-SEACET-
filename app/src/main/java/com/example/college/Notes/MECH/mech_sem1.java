...
public class mech_sem1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("MECH/semester1");
    ...
    private void uploadFile(Uri data) {
        ...
        progressDialog.show();
        StorageReference sRef = mStorageReference.child("MECH/semester1" + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(mech_sem1.this, "File succesfully uploaded......", Toast.LENGTH_SHORT).show();
