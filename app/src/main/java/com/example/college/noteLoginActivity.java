...
public class noteLoginActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void onButtonClick(View v) {
        ...
        dbuser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(noteLoginActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                }
            }
