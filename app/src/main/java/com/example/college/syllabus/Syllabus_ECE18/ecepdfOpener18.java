...
public class ecepdfOpener18 extends AppCompatActivity {
    PDFView myPdfView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecepdf_opener18);myPdfView = (PDFView) findViewById(R.id.pdfView);
        ...
        if(getItem.equals("Functional English"))
        {
            myPdfView.fromAsset("english.pdf").load();
        }
    }
}
