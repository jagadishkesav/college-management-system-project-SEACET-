...
public class IdiomsLibrary {
    ...
    private String mChoices [][] = {
            {"To see signs of plague epidemic", "To get bad smell of a bad dead rat", "To suspect" +
                    "foul dealings","To be in a bad mood"},
            {"9", "11", "13","15"},
    ...
    private String mCorrectAnswers[] = {"To suspect foul designs", "15", "20",
    };
