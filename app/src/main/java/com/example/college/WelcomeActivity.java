...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private boolean isFirstTimeStartApp() {
        SharedPreferences ref = getApplicationContext().getSharedPreferences("College Campus", Context.MODE_PRIVATE);
    ...
    private void startMainActivity(){
        ...
        startActivity(new Intent(WelcomeActivity.this, SecondPageMainActivity.class));
        finish();
    }
