...
import com.example.college.StickyNotes.adapters.NotesAdapter;
import com.example.college.StickyNotes.callbacks.MainActionModeCallback;
import com.example.college.StickyNotes.callbacks.NoteEventListener;
...
import com.example.college.StickyNotes.utils.NoteUtils;
...
import static com.example.college.StickyNotes.EditNoteActivity.NOTE_EXTRA_Key;
import static com.mikepenz.materialdrawer.Drawer.*;


public class StickyNotesMain extends AppCompatActivity implements NoteEventListener, OnDrawerItemClickListener {
    private static final String TAG = "StickyNotesMain";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sticky_notes_main);
    ...
    private void swipeToDelete(final Note swipedNote, final RecyclerView.ViewHolder viewHolder) {
        new AlertDialog.Builder(StickyNotesMain.this)
